...
function loadModule(module, dependencyChain) {
	...
	var url=location.replace(/%n/,module)+"?dt="+(new Date()).valueOf();
    script.src = url;
...
DependencyChain.prototype.require=function() {
	App5.require.apply(this,arguments);
}
DependencyChain.prototype.module=function() {
	App5.module.apply(this,arguments);
}
...
App5.module=function(name,module) {
	...
	function resolveModule(name) {
		if (console.log) console.log('module '+name+' is loaded');
