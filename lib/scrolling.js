...
IPhoneScrollHandler.prototype.init=function(screenElement,scrollingElement)
{
	...
	//this.screenElement.get(0).style.position="relative"
}
...
IPhoneScrollHandler.prototype.onTouchStart=function(e)
{
	...
	this.scrollingElement.get(0).style.webkitTransform = 'translate3D(0, ' + this.getPosition() + 'px,0)';
}
...
IPhoneScrollHandler.prototype.onTouchMove=function(e)
{
	...
	if (this.speed<200) {
		...
		this.scrollingElement.get(0).style.webkitTransform = 'translate3D(0, ' + (scrollTo) + 'px,0)';
		this.running=true;
	}
...
IPhoneScrollHandler.prototype.onTransitionEnd=function(e)
{
	...
	if (this.getPosition() > 0) {
		...
		this.scrollingElement.get(0).style.webkitTransform = 'translate3D(0, 0px,0)';
		return;	
	}
	if (this.getPosition() +this.scrollingElement.height() < this.viewHeight) {
		...
		this.scrollingElement.get(0).style.webkitTransform = 'translate3D(0, '+y+'px,0)';
		return;	
	}
