...
App5Global.prototype.get=function(shortId) {
	return this.ids['app5id_'+this.applicationName+'_'+shortId];
}
 
App5Global.prototype.genId=function(shortId) {
	
	if (shortId) {
		return 'app5id_'+this.applicationName+'_'+shortId ;
	}
	this.sequence++;
...
App5Global.prototype.writeId=function(component,suffix,skipAttribute) {
	var s=component.id+(component.subid != null ? '_xSUBx_'+component.subid:'')+'_xAPP5x_';
	if (suffix) s+=suffix;
...
App5Global.prototype.markUpdate=function(component) {
   console.log("marking for update "+this.shortId(component.id));	
   this.dirty[this.shortId(component.id)]=true;	
}

App5Global.prototype.markUpdated=function(component) {
   delete this.dirty[this.shortId(component.id)];	
...
App5Global.prototype.runApplication=function(applicationName,viewName,settings) {
	...
	this.parser.parse('<a5_application xmlns="'+this.URI+'" />',
