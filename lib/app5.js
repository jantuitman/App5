...
/* is proxied by controller - for viewName
   ...
   this function does not work for cloned components, allways returns the first one.
 */
App5Global.prototype.getComponent=function(viewName,shortId) {
	return this.ids['app5_'+this.applicationName+'_'+viewName+'_'+shortId+'_0']
...
App5Global.prototype.processUpdates=function()
{
   ...
   while (true) {
      ...
      console.log("going to update component "+v);
      component.update(); 	
...
App5Global.prototype.markUpdate=function(component) {
   ...
   this.dirty[component.id+'_'+component.subid]=true;	
}

App5Global.prototype.markUpdated=function(component) {
   delete this.dirty[component.id+'_'+component.subid];	
